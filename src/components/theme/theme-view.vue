  ...
  <div class="theme-view">
    ...
    <div>
      <div>
        ...
        <div :style="{color:theme.primary}" class="price">
          ￥54.50+
          <span>120积分</span>
        </div>
        <div>
      ...
      <div>
        ...
        <div class="specs">
          <div :style="{borderColor:theme.primary,color:theme.primary,backgroundColor:primary}">豆沙绿</div>
        </div>
        <div class="specs">
          <div :style="{borderColor:theme.primary,color:theme.primary,backgroundColor:primary}">S</div>
        </div>
        <div class="specs">
          <div :style="{borderColor:theme.primary,color:theme.primary,backgroundColor:primary}">0元购</div>
        </div>
      </div>
    </div>
  </div>
